...
title: Projects
permalink: /projects/
description: Research and engineering portfolio spanning language-conditioned planning, field robotics, 3D perception, visual SLAM, and developer tools.
nav: true
nav_order: 3
...
{% if site.enable_project_categories and page.display_categories %}
  ...
  <a id="{{ category }}" href="#{{ category }}">
    <h2 class="category">{% if category == 'research' %}Research{% else %}Systems &amp; software{% endif %}</h2>
  </a>
