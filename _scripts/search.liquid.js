          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains '://' -%}{%- assign url = child.permalink -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains '://' -%}{%- assign url = p.permalink -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
